...
class Analyzer():
	...
	def encode_lingo( self) :
		...
		self.rules['classVarDec'] = ['static|field' , 1 , '_type' , 1 , 'varName' , 1 , '_addlVarDec', 3  , ';' , 1 ]
		...
		self.rules['_param'] = ['_type' , 1, 'varName' , 1 ]
		...
		self.rules['varDec'] = ['var' , 1, '_type' , 1, 'varName' , 1 , '_addlVarDec' , 3 , ';' , 1 ]
